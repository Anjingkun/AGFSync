...
if __name__ == "__main__":
    ...
    # parser.add_argument("--pretrained_model_name_or_path", default="models/stable-diffusion-v1-5", type=str)
    # parser.add_argument("--pretrained_vae_model_name_or_path", default=None, type=str)
    # parser.add_argument("--dataset_name", default="dpo_dataset/vqa_dataset_v2", type=str)
    ...
    # parser.add_argument("--output_dir", default="dpo_dataset/post_vqa_dataset_v2", type=str)
    ...
    parser.add_argument("--pretrained_vae_model_name_or_path", default=None, type=str)
    parser.add_argument("--dataset_name", default="dpo_dataset/sdxl_clip_aes_dataset_v1", type=str)
    ...
    parser.add_argument("--good_image_column", default="good_jpg", type=str)
    parser.add_argument("--bad_image_column", default="bad_jpg", type=str)
    parser.add_argument("--output_dir", default="dpo_dataset/post_sdxl_clip_aes_dataset_v1", type=str)
    parser.add_argument("--proportion_empty_prompts", default=0, type=int)
    parser.add_argument("--train_data_dir", default=None, type=str)
    parser.add_argument("--dataset_config_name", default=None, type=str)
    parser.add_argument("--variant", default=None, type=str)
